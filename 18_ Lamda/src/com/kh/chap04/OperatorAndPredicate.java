...
public class OperatorAndPredicate {
	...
	public static void main(String[] args) {
		...
		// Product 클래스를 인자로 받아서 재고가 있다면 true 없다면 false 반환.
		...
		pList.add(new Product("갤럭시 z폴더4", 180000, 85));
		pList.add(new Product("갤럭시 z폴더3", 1550000, 0));
		pList.add(new Product("아이폰14", 1250000, 0));
		pList.add(new Product("아이폰13", 1000000, 25));
