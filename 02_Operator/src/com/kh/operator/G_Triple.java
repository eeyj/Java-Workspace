...
public class G_Triple {
	...
	public void method1() {
		...
		//산술연산이 삼항연산보다 우선 순위가 높아서 가로로 묶어줘야 한다.
	...
	public void method2() {
		...
		// 사용자가 입력한 정수값이 짝수인지 홀수인지 판결 후 출력
		// xx는 짝(홀)수입니다.
		Scanner sc = new Scanner(System.in);
		...
		//System.out.println(num + "은(는) " + result);
		System.out.printf("%d 은(는) %s", num, result);
	}
	
	public void method3() {
		// 사용자로부터 영문자 하나를 입력받아 대문자인지, 아닌지 판별후 출력
	...
	public void method5() {
		// 두개의 정수값과 + 혹은 - 둘중 하나의 문자를 입력받아
		// + 일 경우 두 정수값의 덧셈연산 결과값 출력
		// - 일 경우 두 정수값의 뺄셈연산 결과값 출력
