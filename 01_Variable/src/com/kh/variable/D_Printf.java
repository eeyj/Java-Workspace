...
public class D_Printf {
	...
	/*
	 * System.out.println(출력하고자하는 값); => 값을 출력하고 줄바꿈(개행)까지 넣어줌
	 * System.out.print(출력하고자하는 값); => 값 출력만해줌
	 * 
	 * System.out.printf("출력하고자하는 형식", 출력하고자하는 값, 출력하고자하는 값, ....);
	 * => f는 format(형식)을 의미
	 * => 형식에 맞춰서 값들이 출력이되고 끝(줄바꿈x)
	...
	public void printFtest() {
		...
		System.out.printf("%5d \n", iNum1); //%5d : 5칸의 공간 중 숫자가 오른쪽정렬
		System.out.printf("%-5d 진짜로? \n", iNum1); //%-5d : 5칸의 공간 중 숫자가 왼쪽정렬(음수)
		...
		// %.f : 소숫점아래 2번째줄에서 반올림되어 소수점아래 1번째까지만 출력이 된다.
		// .자릿수로 소수점 제어 가능.
		
		// printf : 포맷 한번으로 간편하게 출력이 가능하다.
		// 단, 지정한 포맷이 갯수와 종류, 뒤에오는 변수의 갯수와 종류가 정확하게 일치해야함
		...
		System.out.printf("%C %S %% %n", ch, str);  // %C, %S : 영어 알파벳인 경우 대문자로 변경해서 출력
