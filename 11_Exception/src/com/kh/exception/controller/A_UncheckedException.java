...
public class A_UncheckedException {
	 ...
	 * - ClassCastException : 혀용할 수 없는 형변환이 진행될 경우 발생하는 예외
	...
	public void method1() {
		...
		// 사용자에게 2개의 정수값을 입력받아 나눗셈 연산 결과 출력
		System.out.print("첫번째 정수 : ");
		int num1 = sc.nextInt();
		System.out.print("두번째 정수 : ");
		int num2 = sc.nextInt();
		// 해결방법 1. 조건문으로 처리 (애초에 예외자체가 발생되지 않게끔 if문으로 조건 검사하기) => 예외처리 x
//		if(num2 == 0) {
...
//		
		// 해결방법 2. 예외처리구문으로 해결(예외가 발생했을 경우를 대비해서 실행할 내용을 정의해두는것)
		/*
		 * try ~ catch문
		 * [표현법]
		 * try {
		...
		try {
			...
			//System.out.println("0으로 나눌 수 없습니다.");
			e.printStackTrace(); // 현재 발생한 오류를 추적할 수 있는 로그 정보 제공
		}
	...
	public void method2() {
		...
		} // 다중 catch 블럭으로 사용할 수 있다. : 예외가 여러개 발생할 가능성이 있는 경우
...
//			System.out.println("예외가 발생하긴 했네요. 근데 배열의 크기를 음수로 입력했거나 부적절한 인덱스로 접근한것 같습니다.");
//		} // 다중 catch블럭이 줄어들었음. 정확히 어떤 에러인지 알 수 없음.
	 ...
	 * 
	 * RuntimeException 계열은 충분히 예측이 가능한 상황이기 때문에 조건문으로 해결하는것을 권장
	 * 
