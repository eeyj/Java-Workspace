...
public class B_StringMethodTest {
	...
	public void method() {
		...
		//    => 현재 문자열에서 old문자를 new문자로 대체(replace)하고 변환한 문자열을 리턴
		...
		System.out.println(String.valueOf(111111111111.343));
