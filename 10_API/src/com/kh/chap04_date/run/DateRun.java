...
public class DateRun {
	...
	public static void main(String[] args) {
		 ...
		 * - 자바 개발 초창기에 급하게 만들어서 완성도가 높지 않은 클래스(다국적으로도 쓰기에 적합하지 않다.)
		 * 
		 */
		
		// 기본생성자를 통해 Date객체 생성 => 현재 날짜 및 시간을 가지고 온다.
		Date today = new Date();
