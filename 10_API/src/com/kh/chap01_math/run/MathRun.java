...
// 생략가능, 보이진 않지만 항상 자동으로 java.lang 패키지가 import 되어있음
	...
	public static void main(String[] args) {
		...
		// 반올림 => Math.roud(double) : 반환값 long형
		...
		// 절대값 => Math.abs(int/double/long/float) : 반환형 (int/double/long/float)
		int num2 = -10;
		 ...
		 * - 모든 메소드 => static 메소드
		 * 
		 * 모든게 다 static이기 때문에 Math.필드명 or Math.메소드명으로 다 접근가능(객체생성할 필요가 없다.)
