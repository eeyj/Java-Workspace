...
public class WrapperRun {
	...
	public static void main(String[] args) {
		...
		// 일반 기본자료형에서 객체 자료형의 메소드를 활용하고 싶을때 --> Wrapper클래스로 변환하여 사용.
		// 자동 형변환이 일어남
		// 기본자료형 => Wrapper 자료형으로 넘어갈때는 자동형변환 (Boxing)
		Integer i1 = num1;
		Integer i2 = num2;
		...
		// a.compareTo(b) : a와 b를 비교해서, a가 b보다 크면 1, a가 b보다 작으면 -1, a가 b와 같으면 0 리턴
