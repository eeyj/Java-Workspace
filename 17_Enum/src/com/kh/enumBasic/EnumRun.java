...
public class EnumRun {
	 ...
	 * 기존에 사용하던 상수를 정의하는 방법 final static와 같은 기능함.
	 ...
	 * 3) monday라는 문자를 저장하고 싶을 경우 -> 새롭게 선언해줘야함.
	...
	public static void main(String[] args) {
		 ...
		 *    ex) 하나의 요일에 해당하느느 데이터를 (MON, MONDAY, 1, 월요일) 하나의 상수필드로 합칠 수 있다.
		 *    ex) true, Y, 1
