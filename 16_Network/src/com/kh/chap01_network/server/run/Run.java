...
public class Run {
	 ...
	 * - 사용법 : Socket socket = new Socket(String IPAdderss, int portNumber)
	 * - 메소드
	 *  > OutputStream out = client.getOutputStream() 메소드를 통해 데이터를 "내보낼수있는" 출력스트림을 생성.
	 *  > InputStream in = client.getInputStream() 메소드를 통해 데이터를 잀을 수 있는 입력 스트림을 생성.
	 * 
	 * 
	 */
	public static void main(String[] args) {
		
		new Server().setverStrart();
