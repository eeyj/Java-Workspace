...
public interface Basic {
	 ...
	 * - 인터페이스는 다중 상속을 허용한다.
	 *   (결국 메소드에 대한 정의만 하고 있어서 메소드가 겹치더라도 최종 구현 부분은 구현 클래스에서 이루어 질것이기때문에
	 *    다중상속(구현)이 가능함.)
	...
	/*public static final*/ int num = 10; //기울임꼴 == static변수
	// 인터페이스에는 상수필드만 정의할 수 있기때문에
	// 앞에 public static final필드가 자동으로 붙어있게됨
	
	
	/*public abstract*/ void eat();
	void sleep();
	// 인터페이스에서는 추상메소드만 정의 할 수 있기때문에 메소드의 몸통부 작성이 불가능하며
