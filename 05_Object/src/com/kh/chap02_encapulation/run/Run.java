...
public class Run {
	 ...
	 *    캡슐화를 하지 않으면 : 외부로부터 직접접근이 가능하기 떄문에 함부로 값이 변질되거나 조회를 막지 못하는 문제
	 *    
	 *     1) 정보은닉 : private
	 *        필드들을 외부로부터 직접 접근을 막기 위해 public 대신에 private접근제한자 사용
	 *        ex) 학생들이 본인의 성적을 함부로 바꿀수 없게, 다른 학생의 성적이 함부로 조회되지 않도록
	 *        
	 *     2) setter / getter 메소드
	...
	public static void main(String[] args) {
		...
		/*
		 * hong.name = "홍길동"; //the filed Student.name is not visible hong.age;
		 * hong.height = 166.6;
		 */
