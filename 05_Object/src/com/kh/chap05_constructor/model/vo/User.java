...
public class User {
	...
	public User() {
		 ...
		 * JVM이 클래스를 컴파일할때 기본생성자가 없는 경우 항상 자동으로 만들어주기 때문.(매개변수가있는 생성자가 없는 경우)
		 * 단, 매개변수가 잇는 생성자가 이미 클래스 안에 작성되어있는 경우 반드시 기본생성자도 함께 작성해줘야한다.
	...
	public User(String userId, String userPwd, String userName, int age, char gender) {
		...
		/*
		 * 생성자 내부에서 생성자끼리 중복되는 코드가 있는 경우 , this생성자를 통해 같은 클래스 내에 있는 다른 생성자 호출 가능함
