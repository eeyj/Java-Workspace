...
public class PropertiesRun1 {
	...
	public static void main(String[] args) {
		...
		//              단, properties의 특징 : key, value 값 모두 String으로 제한되어있음.
		
		
		Properties prop = new Properties();
		
		// String이 아닌 값을 넣게 될 경우.
		// Map 계열이기 때문에 put메소드 활용 가능. 
//		prop.put("다이제", new Snack("초코맛", 1000));
//		
//		System.out.println(prop);
//		System.out.println(prop.get("다이제"));
//		
//		// 단, 주로 Properties를 사용하는 경우는 Properties에 담겨 있는 key+value값 세트들을 파일로 기록하기 위해 사용됨.
//		
//		try {
...
//		
		...
		System.out.println(prop); // 저장 순서 유지 안됨. key값 중복 안됨
