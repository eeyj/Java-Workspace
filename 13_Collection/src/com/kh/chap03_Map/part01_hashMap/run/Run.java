...
public class Run {
	...
	public static void main(String[] args) {
		...
		// 1. 저장순서 유지 안됨
		// 2. value값이 동일하다고해도, key값이 중복되지 않기 때문에 잘 저장됨.
		
		hm.put("포카칩", new Snack("매운맛",1200));
		// 중복된 key 값의 value값으로 덮어씌우기됨.
		System.out.println(hm); 
		
		// 2. get(Object key) : V => 컬렉션에서 해당 키값의 value값을 돌려주는 메소드
		System.out.println(hm.get("다이제"));
		
		Snack s = hm.get("칸초"); // 제네릭 설정을 해놨기때문에 Snack타입 객체로 강제 형변환 하는 과정이 생략되었다.
		...
		// 순차적으로 HashMap안에 담겨 있는 값에 접근하고자 할때 ?
